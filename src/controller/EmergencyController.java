...
public class EmergencyController {
	...
	public Response register(@FormDataParam("location") String location,
		...
		String fileName2 = context.getRealPath(File.separator) + File.separator + "files" + File.separator + "emergencies.ser";
	...
	public String getEmergencies(@Context ServletContext context)
		...
		ArrayList<Emergency> read = new ArrayList<Emergency>();
		String fileName = context.getRealPath(File.separator) + File.separator + "files" + File.separator + "emergencies.ser";
		File file = new File(fileName);
		if (file.exists()) {
