...
public class UserController {
	...
	public Response register(@FormDataParam("firstName") String firstName,
		...
		String fileName = context.getRealPath(File.separator) + File.separator + "files" + File.separator + "territories.ser";
		...
		String fileName2 = context.getRealPath(File.separator) + File.separator + "files" + File.separator + "/users.ser";
	...
	public Boolean checkUsername(@FormParam("username") String username,
		...
		String fileName = context.getRealPath(File.separator) + File.separator + "files" + File.separator + "users.ser";
		File file = new File(fileName);
	...
	public String loadUsers(@Context ServletContext context)
		...
		if (file.exists()) {
			...
			User a1 = new Admin("admin", "123456", "Admin", "Ad",
					"0643891303", "admin@gmail.com", "carlos-cardenas.png", Role.ADMIN);
			User a2 = new Admin("gagela", "123456", "Vladimir", "Gajcin‡",
					"0643891303", "gagela@gmail.com", "carlos-cardenas.png", Role.ADMIN);
			User a3 = new Volunteer("gags", "123456", "Vladas", "Gagas",
					"0643891303", "gags@gmail.com", "carlos-cardenas.png", Role.VOLUNTEER,
